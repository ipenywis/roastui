...
CREATE TABLE "new_RoastedDesigns" (
    ...
    "internalImprovedReact" TEXT NOT NULL DEFAULT '',
...
INSERT INTO "new_RoastedDesigns" ("createdAt", "id", "improvedHtml", "improvedReact", "improvements", "internalImprovedHtml", "name", "originalImageUrl", "uiHighlights", "updatedAt", "userId", "whatsWrong") SELECT "createdAt", "id", "improvedHtml", "improvedReact", "improvements", "internalImprovedHtml", "name", "originalImageUrl", "uiHighlights", "updatedAt", "userId", "whatsWrong" FROM "RoastedDesigns";
